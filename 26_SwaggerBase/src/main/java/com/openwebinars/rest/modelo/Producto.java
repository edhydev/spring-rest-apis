...
public class Producto {
  ...
  @ApiModelProperty(value = "Nombre del producto", dataType = "String", example = "Peñafiel Piñada 2L", position = 2)
  private String nombre;

  @ApiModelProperty(value = "Precio del producto", dataType = "float", example = "28.50", position = 3)
